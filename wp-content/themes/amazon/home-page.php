...
<div class="banner-slider">
        ...
        <img src="<?php bloginfo('template_directory'); ?>/images/banner1.jpg" alt="Chania" width="460" height="345">
        ...
        <div class="carousel-caption">
          ...
          <h2>Amazon product Optimization</h2>
              ...
              <div class="item">
        <img src="<?php bloginfo('template_directory'); ?>/images/banner1.jpg" alt="Flower" width="460" height="345">
        <div class="carousel-caption">
            ...
            <div class="row four-block">
                <div class="col-md-3 col-sm-3">
                    <div class="block welcome-sec">
                        <h2>Welcome</h2>
                        <p>Create your Amazon help account<br> Register Securely
                        <p>
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <h2 class="heading">Pay Per Click</h2>
                      <div class="blog-pic">
                        <img src="<?php bloginfo('template_directory'); ?>/images/bag.jpg" alt="img">
                      </div>
                ...
                <div class="col-md-3 col-sm-3">
                        <div class="small-block review-block align-center">
                            <h2 class="heading">Amazon Reviewers Community</h2>
                        ...
                        <div class="small-block template-block">
                            ...
                            <button class="btn tem-btn">Get Template</button>
                            <p>Connect your template website with amazon
(bigcommerce, shopify amazon api)</p>
                        </div>
                </div>
            </div>  
        </div>
