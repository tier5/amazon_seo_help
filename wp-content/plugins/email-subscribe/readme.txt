...
2. Send Newsletter via cronjob

3. You Can Change Newsletter box's backgroud color,Border Color,Border Size,Modal Border Color,Title Color,Title Font Size,Sub Title Font Color,
   Sub Title Font Size,Modal textbox colors,Buttons color etc.
   
4. Show Hide Name Feild In Modal Popup and In Newsletter Widget

5. Mass email to subscribers.

6. Social Media Links.

7. Email Notification to admin when someone subscribe.

8. Option to activate Subscriber via activation link or automatic subscribe

9. Import subscribers.

10. Export subscribers.

11. Mass delete subscribers.

12. Newsletter email templates.
